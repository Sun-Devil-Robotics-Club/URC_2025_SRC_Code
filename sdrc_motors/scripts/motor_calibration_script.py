...
def autocal_stepper(odrv, odrv_ID):
    ...
    odrv.axis1.controller.config.pos_gain = 30
    odrv.axis1.controller.config.vel_gain = 0.02
    odrv.axis1.controller.config.input_mode = 5  # "INPUT_MODE_TRAP_TRAJ"
    odrv.axis1.trap_traj.config.vel_limit = 30
    odrv.axis1.trap_traj.config.accel_limit = 5
    odrv.axis1.trap_traj.config.decel_limit = 5
